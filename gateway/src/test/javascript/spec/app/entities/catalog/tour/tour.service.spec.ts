    ...
    describe('Tour Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'catalog/api/tours';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Tour', () => {
                service.create(new Tour(null)).subscribe(received => {
            ...
            it('should update a Tour', () => {
                service.update(new Tour(123)).subscribe(received => {
